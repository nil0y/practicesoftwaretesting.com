...
export const test = base.extend({
    homePage: async ({page}, use) => {
        const homepage = new HomePage(page); // Created object of the HomePage class
        await homepage.goto(); //called goto function
        await use(homepage);
    },
    // we will also receive data from homePage fixture
    loggedInPage: async ({page, homePage}, use) => {
